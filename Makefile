...
# openstack.org/ironic-operator-bundle:$VERSION and openstack.org/ironic-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/$(USER)/ironic-operator
...
test: manifests generate fmt vet envtest ginkgo ## Run tests.
	...
	$(GINKGO) --trace --cover --coverpkg=../../api/v1beta1,../../internal/ironic,../../internal/ironicapi,../../internal/ironicconductor,../../internal/ironicinspector,../../internal/ironicneutronagent, --coverprofile cover.out --covermode=atomic --randomize-all ${PROC_CMD} $(GINKGO_ARGS) ./test/...
